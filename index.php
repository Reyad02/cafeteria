...
<?php if($_SESSION['type_id']==4){?>
            <button class='btn' id='add-to-stock' onclick='addStock(10)' style='background-color:gray; margin-left: 14px;'>Add 10 To All</button>
            <?php }?>
<div id=ajax-clear>
            <?php 
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <div class="food-menu-box">
                            ...
                            <div class="food-menu-desc">
                                ...
                                <?php }else{?>
                                  <span>Stock: </span>
                                  <span class="btn btn-sm btn-secondary btn-minus" style="font-size: 30px;"><b>-</b></span>
                                        <input onchange='changeStock(<?php echo $id;?>,this.value)'type="number" name="stock" class="stock" value=<?php echo $stock;?> min="0">
                                        <span class="btn btn-sm btn-secondary btn-plus" style="font-size: 19px;"><b>+</b></span>
                                  <?php }?>
                                <p class="food-detail">
                                    <?php echo $category; ?>
                                </p>
                                ...
                                <div class="d-flex jusctify-content-center col-md-12">
                                    <div class="qty-div" style="height: 6%;">
                                        <span class="btn btn-sm btn-secondary btn-minus" style="font-size: 30px;"><b>-</b></span>
                                        <input type="number" style="width: 15%; text-align: center;" name="qty" class="qty" value="1" min="1">
                                        <span class="btn btn-sm btn-secondary btn-plus"  style="font-size: 19px;"><b>+</b></span>
                                    </div>
                                    
                                    <button class="btn btn-primary btn-block btn-sm col-sm-4 add_to_cart" type="button" style="padding: 7px; width:43%" value=<?php echo $id?>>Add to Cart</button>
