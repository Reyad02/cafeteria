...
<body>
    ...
    <table>
        ...
        <?php
                      ...
                      ?>
                      <select name="type_of_food" id='type'>
                        <?php
    ...
    <div>
           <a href="admin_to_items.php" id="back_in">Back </a>
            <input onclick='updateFood()' type="submit"  id="button" name="submit" value="Update">
            <!--a onclick='' class='btn btn-primary'>Update</a-->
        </div>
...
if($_POST['submit']){
    ...
    $sql2 = "UPDATE food_items SET id ='$id',name ='$name',price ='$price',stock='$stock', food_type_id='$Food_Type' WHERE id='$id' ";
